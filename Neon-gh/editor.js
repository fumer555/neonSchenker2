! function(e) {
    ...
    t.initDisplayControls = function(e, t) {
        ...
        i.parentElement.addEventListener("click", () => {
            "none" === n.style.display ? (n.style.display = "", i.setAttribute("xlink:href", "../Neon-gh/assets/img/icons.svg#dropdown-down")) : (n.style.display = "none", i.setAttribute("xlink:href", "../Neon-gh/assets/img/icons.svg#dropdown-side"))
        })
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        primitiveTab: "<p class='control'><button id='punctum' class='button insertel smallel' aria-label='punctum' title='punctum'><img src='../Neon-gh/assets/img/punctum.png' class='image'/></button></p><p class='control'><button id='virga' class='button insertel smallel' aria-label='virga' title='virga'><img src='../Neon-gh/assets/img/virga.png' class='image'/></button></p><p class='control'><button id='virgaReversed' class='button insertel smallel' aria-label='Reversed Virga' title='Reversed Virga'><img src='../Neon-gh/assets/img/virga_reversed.png' class='image'/></button></p><p class='control'><button id='diamond' class='button insertel smallel' aria-label='inclinatum' title='inclinatum'><img src='../Neon-gh/assets/img/diamond.png' class='image'/></button></p><p class='control'><button id='custos' class='button insertel smallel' aria-label='custos' title='custos'><img src='../Neon-gh/assets/img/custos.png' class='image'/></button></p><p class='control'><button id='cClef' class='button insertel smallel' aria-label='C Clef' title=' C Clef'><img src='../Neon-gh/assets/img/cClef.png' class='image' /></button></p><p class='control'><button id='fClef' class='button insertel smallel' aria-label='F Clef' title='F Clef'><img src='../Neon-gh/assets/img/fClef.png' class='image'/></button></p><p class='control'><button id='liquescentA' class='button insertel smallel' aria-label='Liquescent A' title='Liquescent A'><img src='../Neon-gh/assets/img/liquescentA.png' class='image'/></button></p><p class='control'><button id='liquescentC' class='button insertel smallel' aria-label='Liquescent C' title='Liquescent C'><img src='../Neon-gh/assets/img/liquescentC.png' class='image'/></button></p><p class='control'><button id='flat' class='button insertel smallel' aria-label='Flat' title='Flat'><img src='../Neon-gh/assets/img/accidFlat.png' class='image'/></button></p><p class='control'><button id='natural' class='button insertel smallel' aria-label='Natural' title='Natural'><img src='../Neon-gh/assets/img/accidNatural.png' class='image'/></button></p>",
        groupingTab: "<p class='control'><button id='pes' class='button insertel smallel' aria-label='pes' title='pes'><img src='../Neon-gh/assets/img/pes.png' class='image'/></button></p><p class='control'><button id='clivis' class='button insertel smallel' aria-label='clivis' title='clivis'><img src='../Neon-gh/assets/img/clivis.png' class='image'/></button></p><p class='control'><button id='scandicus' class='button insertel smallel' aria-label='scandicus' title='scandicus'><img src='../Neon-gh/assets/img/scandicus.png' class='image'/></button></p><p class='control'><button id='climacus' class='button insertel smallel' aria-label='climacus' title='climacus'><img src='../Neon-gh/assets/img/climacus.png' class='image'/></button></p><p class='control'><button id='torculus' class='button insertel smallel' aria-label='toculus' title='toculus'><img src='../Neon-gh/assets/img/torculus.png' class='image'/></button></p><p class='control'><button id='porrectus' class='button insertel smallel' aria-label='porrectus' title='porrectus'><img src='../Neon-gh/assets/img/porrectus.png' class='image'/></button></p><p class='control'><button id='pressus' class='button insertel smallel' aria-label='pressus' title='pressus'><img src='../Neon-gh/assets/img/pressus.png' class='image'/></button></p>",
        systemTab: "<p class='control'><button id='staff' class='button insertel longel' aria-label='system' title='system'><img src='../Neon-gh/assets/img/staff.png' class='image' /></button></p><p>Click upper left and lower right corners of new staff.</p>"
    }, t.insertControlsPanel = "<p class='panel-heading' id='insertMenu'>Insert<svg class='icon is-pulled-right'><use id='toggleInsert' xlink:href='../Neon-gh/assets/img/icons.svg#dropdown-down'></use></svg></p><div id='insertContents' style='overflow-y: hidden;'><p class='panel-tabs'><a id='primitiveTab' class='insertTab'>Primitive Elements</a><a id='groupingTab' class='insertTab'>Grouping</a><a id='systemTab' class='insertTab'>System</a></p><a class='panel-block has-text-centered'><div id='insert_data' class='field is-grouped buttons'></div></a></div>", t.editControlsPanel = "<p class='panel-heading' id='editMenu'>Edit<svg class='icon is-pulled-right'><use id='toggleEdit' xlink:href='../Neon-gh/assets/img/icons.svg#dropdown-down'></use></svg></p><div id='editContents'><a class='panel-block'><label>Select By:&nbsp;</label><div class='field has-addons buttons' style='overflow-x: auto;'><p class='control'><button class='button sel-by is-active' id='selBySyl'>Syllable</button></p><p class='control'><button class='button sel-by' id='selByNeume'>Neume</button></p><p class='control'><button class='button sel-by' id='selByNc'>Neume Component</button></p><p class='control'><button class='button sel-by' id='selByStaff'>Staff</button></p><p class='control'><button class='button sel-by' id='selByLayerElement'>Layer Element</button></p></div></a><div class='field is-grouped buttons'><p class='control'><a id='moreEdit' class='panel-block is-invisible'><a id='extraEdit' class='panel-block is-invisible'><a id='neumeEdit' class='panel-block is-invisible'></div>", t.ncActionContents = "<label>Change Head Shape:&nbsp;</label><div id='drop_select' class='dropdown'><div class='dropdown-trigger'><button id='select-options' class='button' aria-haspopup='true' aria-controls='dropdown-menu'><span>Head Shapes</span><svg class='icon'><use xlink:href='../Neon-gh/assets/img/icons.svg#dropdown-down'></use></svg></button></div><div class='dropdown-menu' id='dropdown-menu' role='menu'><div class='dropdown-content'><a id='Punctum' class='dropdown-item'>Punctum</a><a id='Virga' class='dropdown-item'>Virga</a><a id='VirgaReversed' class='dropdown-item'>Reversed Virga</a><a id='LiquescentClockwise' class='dropdown-item'>Liquescent C</a><a id='LiquescentAnticlockwise' class='dropdown-item'>Liquescent A</a><a id='Inclinatum' class='dropdown-item'>Inclinatum</a></div></div></div><p class='control'></p></div>", t.neumeActionContents = "<label>Change Grouping:&nbsp;</label><div id='drop_select' class='dropdown'><div class='dropdown-trigger'><button id='select-options' class='button' aria-haspopup='true' aria-controls='dropdown-menu'><span>Groupings</span><svg class='icon'><use xlink:href='../Neon-gh/assets/img/icons.svg#dropdown-down'></use></svg></button></div><div class='dropdown-menu' id='dropdown-menu' role='menu'><div class='dropdown-content scrollable-dropdown'><a id='Pes' class='dropdown-item grouping'>Pes</a><a id='Pes subpunctis' class='dropdown-item grouping'>Pes Subpunctis</a><a id='Clivis' class='dropdown-item grouping'>Clivis</a><a id='Scandicus' class='dropdown-item grouping'>Scandicus</a><a id='Scandicus flexus' class='dropdown-item grouping'>Scandicus Flexus</a><a id='Scandicus subpunctis' class='dropdown-item grouping'>Scandicus Subpunctis</a><a id='Climacus' class='dropdown-item grouping'>Climacus</a><a id='Climacus resupinus' class='dropdown-item grouping'>Climacus Resupinus</a><a id='Torculus' class='dropdown-item grouping'>Torculus</a><a id='Torculus resupinus' class='dropdown-item grouping'>Torculus Resupinus</a><a id='Porrectus' class='dropdown-item grouping'>Porrectus</a><a id='Porrectus flexus' class='dropdown-item grouping'>Porrectus Flexus</a><a id='Porrectus subpunctis' class='dropdown-item grouping'>Porrectus Subpunctis</a><a id='Pressus' class='dropdown-item grouping'>Pressus</a></div></div></div><div><p class='control'><button class='button' id='ungroupNcs'>Ungroup</button></p></div>", t.staffActionContents = "<label>Merge Systems:&nbsp;</label><div><p class='control'><button id='merge-systems' class='button'>Merge</button><button class='button' id='delete'>Delete</button></p></div>", t.defaultActionContents = "<div><p class='control'><button class='button' id='delete'>Delete</button></p></div>", t.defaultSylActionContents = "<div><p class='control'><button class='button' id='delete'>Delete</button><button class='button' id='changeStaff'>Re-associate to nearest staff</button></p></div>", t.custosActionContents = "<div><p class='control'><button class='button' id='delete'>Delete</button><button class='button' id='changeStaff'>Re-associate to nearest staff</button></p></div>", t.splitActionContents = "<label>Split System:&nbsp;</label><div><p class='control'><button id='split-system' class='button'>Split</button><button id='reset-rotate' class='button'>Reset Rotate</button><button class='button' id='delete'>Delete</button></p></div>", t.clefActionContents = "<label>Change Clef Shape:&nbsp;</label><div id='drop_select' class='dropdown'><div class='dropdown-trigger'overflow='auto'><button id='select-options' class='button' aria-haspopup='true' aria-controls='dropdown-menu'><span>Clef Shapes</span><svg class='icon'><use xlink:href='../Neon-gh/assets/img/icons.svg#dropdown-down'></use></svg></button></div><div class='dropdown-menu' id='dropdown-menu' role='menu'><div class='dropdown-content'><a id='CClef' class='dropdown-item'>C Clef</a><a id='FClef' class='dropdown-item'>F Clef</a></div></div></div></div>", t.groupingMenu = {
    ...
    t.initEditModeControls = function(e) {
        ...
        e.parentElement.addEventListener("click", () => {
            "none" === n.style.display ? (n.style.display = "", e.setAttribute("xlink:href", "../Neon-gh/assets/img/icons.svg#dropdown-down")) : (n.style.display = "none", e.setAttribute("xlink:href", "../Neon-gh/assets/img/icons.svg#dropdown-side"))
        }), t.parentElement.addEventListener("click", () => {
            "none" === i.style.display ? (i.style.display = "", t.setAttribute("xlink:href", "../Neon-gh/assets/img/icons.svg#dropdown-down")) : (i.style.display = "none", t.setAttribute("xlink:href", "../Neon-gh/assets/img/icons.svg#dropdown-side"))
        })
    ...
    const i = fetch("../Neon-gh/assets/mei-all.rng");
    let r, s, o;
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        const e = await fetch("../Neon-gh/assets/template.html");
